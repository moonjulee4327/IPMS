...
<body>
	<div class="content-wrapper" style="margin-top: 100px";>
		...
		<div class="row breadcrumbs-top"
			style="margin-left: 800px; font-weight: bold;">
			<div class="breadcrumb-wrapper col-5">
				<ol class="breadcrumb"
		...
		<div id="accordion"
			style="width: 70%; margin-top: 100px; height: auto; margin-left: 250px;">
			<div class="card">
			...
			<div class="card">
				...
				<div id="collapseThree" class="collapse"
					...
					<div class="card-body">Anim pariatur cliche reprehenderit,
						...
						sunt aliqua put a bird on it squid</div>
				</div>
			</div>
		</div>
</body>
