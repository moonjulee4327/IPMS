                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="app-invoice-table" class="table dataTable no-footer dtr-column"
                                ...
                                <tbody>
                                    <!-- 리스트 조회 시작 -->
                                    <c:forEach var="memSvcQaA" items="${memSvcQaASelect}" varStatus="stat"> 
                                    <tr role="row" class="odd">
                                        <td style="padding-left: 40px;">
                                            ${stat.count}
                                        </td>
                                        <td>
                                            <a href="/main/svcQaADetail?qnaNum=${memSvcQaA.qnaNum}">${memSvcQaA.qnaTitle}</a>
                                        </td>
                                        <td>
                                            ${memSvcQaA.writer}
                                        </td>
                                        ...
                                        <td style="padding-left: 23px">
                                            <fmt:formatDate value="${memSvcQaA.qnaWriteDate}" pattern="yyyy-MM-dd"/> 
                                        </td>
                                    </tr>
                                    </c:forEach>
                                    <!-- 리스트 조회 끝 -->
                            ...
                            <div class="dataTables_paginate paging_simple_numbers" id="app-invoice-table_paginate">
                                <ul class="pagination">
                                    ...
                                    <li class="paginate_button page-item previous" id="app-invoice-table_previous">
                                        <a href="/main/memSvcQaA?pageNum=${pageVO.pageNum - 1}&amount=${pageVO.amount}" aria-controls="app-invoice-table" data-dt-idx="0" tabindex="0" class="page-link">Previous</a>
                                    </li>
                                    </c:if>
                                    <!-- 이전 버튼 끝 -->
                                    ...
                                    <c:when test="${pageVO.pageNum eq num }">
	                                    <li class="paginate_button page-item active">
	                                        <a href="/main/memSvcQaA?pageNum=${num}&amount=${pageVO.amount}" aria-controls="app-invoice-table" data-dt-idx="1" tabindex="0" class="page-link info">${num}</a>
	                                    </li>
                                    </c:when>
                                    <c:otherwise>
                                    	<li class="paginate_button page-item">
	                                        <a href="/main/memSvcQaA?pageNum=${num}&amount=${pageVO.amount}" aria-controls="app-invoice-table" data-dt-idx="1" tabindex="0" class="page-link">${num}</a>
	                                    </li>
                                    </c:otherwise>
                                    </c:choose>
                                    </c:forEach>
                                    ...
                                    <li class="paginate_button page-item next" id="app-invoice-table_next">
                                        <a href="/main/memSvcQaA?pageNum=${pageVO.pageNum + 1}&amount=${pageVO.amount}" aria-controls="app-invoice-table" data-dt-idx="6" tabindex="0" class="page-link">Next</a>
                                    </li>
                                    </c:if>
                                    <!-- 다음 버튼 끝 -->
