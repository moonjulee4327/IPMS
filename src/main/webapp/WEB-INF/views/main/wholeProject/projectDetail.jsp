            ...
            <section id="search-images" class="card overflow-hidden">
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="app-content container center-layout mt-2" style="margin-top: 100px;">
                        ...
                        <c:set var="checkCode" value="${check.memCode}"/>
                                    ...
                                    <form class="form-row">
                                        <div class="form-group col-md-6 mb-2">
                                            ...
                                            <input type="text" id="projName" class="form-control border-primary"
                                                   placeholder="Project Name" name="projName"
                                                   value="${item.projName}" readonly/>
                                            ...
                                            <div class="form-group">
                                                <div style="float: left">
                                                    ...
                                                    <input type="text" id="projStrtDate"
                                                           ...
                                                           value="<fm:formatDate value="${item.projStrtDate}"/>"
                                                           readonly>
                                                </div>
                                                <div style="float:right;">
                                                    ...
                                                    <input type="text" id="projEndDate"
                                                           ...
                                                           pattern="yyyy-MM-dd"
                                                           value="<fm:formatDate value="${item.projEndDate}"/>"
                                                           readonly/>
                                                </div>
                                            </div>
                                        </div>
