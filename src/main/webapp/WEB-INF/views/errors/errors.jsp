...
<head>
    ...
    <title>Error 500 - Stack Responsive Bootstrap 4 Admin Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/stack-admin-v4.0/stack-admin/app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                ...
                                <h3 class="text-uppercase text-center">${msg}</h3>
                            </div>
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-12 col-md-12 mb-1">
                                        <a href="index.html" class="btn btn-primary btn-block"><i class="feather icon-home"></i> Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
