...
<!-- Topbar -->
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-static-top navbar-light navbar-border navbar-brand-center fixed-top"
			...
			<div class="collapse navbar-collapse" id="navbar-mobile">
				<ul class="nav navbar-nav mr-auto float-left">
					<li class="nav-item d-none d-md-block"><a href="/main/page">
						<img src="${pageContext.request.contextPath}/resources/logoImage/logo.jpg"  style="width: 120px;height: auto;margin-top: 10px" alt="">
					</a>
					</li>

					<li class="nav-item"><a class="navbar-brand" href="#"  style="margin-left: 250px;margin-top: 10px">
						<button type="button" class="btn btn-outline-light btn-min-width mr-1 mb-1" style="border: none;font-weight: bold">전체 프로젝트</button>
					</a></li>

					<li class="nav-item"><a class="navbar-brand" href="#"  style="margin-left: 100px;margin-top: 10px">
						<button type="button" class="btn btn-outline-light btn-min-width mr-1 mb-1"style="border: none;font-weight: bold">프로젝트 생성</button>
					</a></li>

					<li class="nav-item"><a class="navbar-brand" href="#"  style="margin-left: 80px;margin-top: 10px;position: relative" >
						<button type="button" class="btn btn-outline-light btn-min-width mr-1 mb-1"style="border: none;font-weight: bold">고객센터</button>
					</a></li>
