									...
									<ul class="pagination">
										...
										<c:when test="${pageVO.pageNum eq num}">
											<li class="paginate_button page-item active">
												<a href="/proj/${projId}/freeboard?pageNum=${num}&amount=${pageVO.amount}&keyword=${keyword}&category=${category}"" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link info">${num}</a>
											</li>
										</c:when>
										<c:otherwise>
											<li class="paginate_button page-item">
												<a href="/proj/${projId}/freeboard?pageNum=${num}&amount=${pageVO.amount}&keyword=${keyword}&category=${category}"" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link">${num}</a>
											</li>
										</c:otherwise>
										</c:choose>
										</c:forEach>
