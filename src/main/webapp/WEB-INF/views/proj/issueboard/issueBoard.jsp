            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title"><b>Issue Board</b></h4>
                  </div>
                  <div class="card-content collapse show">
                     <div class="card-body card-dashboard">
                        <h1 style=" font-family: 'MICEGothic Bold';">프로젝트 이슈 게시판입니다!</h1>
                           ...
                           <button class="btn btn-secondary border-grey border-lighten-1" type="button"><i class="feather icon-search"></i></button>
                       			</span>
                  			 </div>
<!--                            </div> -->
                           </div>
                        <div>
                           <table class="table table-striped table-bordered base-style"
                              ...
                              <thead>
                                 <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 5px;">글번호</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 450px;">제목</th>
